...
public class C05_İstenmeyenİsimleriSilme {
    ...
    public static void main(String[] args) {
        ...
        // başka bir listeye atamadan da direk silme yapabilir miyiz?
        ...
        for (int i = 0; i < isimler.size(); i++) {
            ...
            if ((isimler.get(i).contains(istenmeyenHarf))){
                ...
                i--; // isim silindiği için kontrole bir öncekşnden baslaması için
            }

        }

        System.out.println(isimler); // [Saido, Kamil]
